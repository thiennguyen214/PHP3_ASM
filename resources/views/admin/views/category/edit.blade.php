    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('cate.index') }}">Danh sách danh mục</a></li>
                <li class="breadcrumb-item"><b>Cập nhật</b></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form class="row" action="{{ route('cate.update', $cate->id) }}" method="POST"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a class="btn btn-cancel" href="{{ route('cate.index') }}">Hủy bỏ</a>
                            </div>
                        </form>
                    </div>
